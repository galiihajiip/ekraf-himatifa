      ...
      <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-28 lg:px-8 lg:py-36">
        <div className="mx-auto max-w-3xl text-center">
          <h1 className="text-3xl font-extrabold tracking-tight text-white sm:text-4xl lg:text-5xl">
            Belanja Cerdas, Aman, dan{" "}
            <span className="text-gold">Terpercaya</span>
          </h1>
          <p className="mt-4 text-base text-gray-300 sm:mt-6 sm:text-lg">
            Temukan aplikasi premium, merchandise eksklusif HIMATIFA, dan jasa
            print berkualitas — semua dalam satu platform yang aman dan mudah.
          </p>
